...
if (params.help) {
    log.info ''
    log.info 'Benchmark of GEMMA and MANTA in a simulation using real GT data'
    log.info '======================================================================='
    ...
    log.info ' --PTgen PHENO GENERATION    error for phenotype data generation: mvnorm, simplex, multinom or copula definition (default: mvnorm)'
    ...
    log.info ' --a NUMBER AFFECTED         [WARNING] number of responses affected by causal variant when --h2s is not 0 [--b equal] (default: 3)'
    log.info ''
